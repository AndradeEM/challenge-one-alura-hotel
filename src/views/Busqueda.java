...
import com.jdbc.controller.HuespedesController;
...
public class Busqueda extends JFrame {
	...
	private void llenarTablaHuespedes() {
		...
		// Llenar tabla de huespedes
	List<Huespedes> huesped = buscarHuespedes();
	
	try {
		for (Huespedes huespedes : huesped) {
			modeloHuesped.addRow(new Object[] { huespedes.getId() , huespedes.getNombre(),
					huespedes.getApellido(), huespedes.getFechaNacimiento(), huespedes.getNacionalidad(), huespedes.getTelefono(), huespedes.getIdReserva()});
		}
	}
	catch (Exception e) {
		throw e;
