...
public class ReservasView extends JFrame {
	...
	public ReservasView() throws SQLException {
		//Instanciando la clase reservaController
		...
		setResizable(false);
		setLocationRelativeTo(null); // posicional as ventanas en el centro
		setUndecorated(true); // remueve la barra superior de la ventana
		...
		txtValor.setBounds(78, 328, 159, 33);
	...
	private void calcularValor(JDateChooser fechaEntrada, JDateChooser fechaSalida) {
		if (fechaEntrada.getDate() != null && fechaSalida.getDate() != null) {
			...
			int dias = -1;  //usamos -1 para contar a partir del siguiente dia
			int diaria = 1200;
			int valor;
			
			while (inicio.before(fin) || inicio.equals(fin)) {
				dias++;
				inicio.add(Calendar.DATE, 1); //dias a aumentar
			}
			valor = dias * diaria;
	...
	private void guardarReserva() throws SQLException {
		...
		JOptionPane.showMessageDialog(contentPane, "Reserva guardada con éxito. Reserva # " + nuevaReserva.getId());
